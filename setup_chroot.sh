...
usage()
{
	...
	echo "Usage: $0 [--force] [--beta | --suite SUITE] [--name NAME] [--extra-apt-source 'deb http://MIRROR SUITE COMPONENT...'] [--output-dir <DIRNAME>] [--tarball TARBALL] [--prefix <PREFIX>] --i386 | --amd64"
	exit "$1"
}
...
main()
{
	...
	'amd64,beta,extra-apt-source:,force,i386,name:,output-dir:,prefix:,suite:,tarball:,help' \
	-n "$0" -- "$@")"
